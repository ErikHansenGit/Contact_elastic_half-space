...
[p_con,g,err] = elpl_contact_pressure_polonsky_linear(p_hd,sld.H,geo.prof,W_aim,geo.Nx1,geo.Nx2,geo.dx1,geo.dx2,fft2_Kernel,err_tol,it_max,h_ref);
...
function [p_con,g,err] = elpl_contact_pressure_polonsky_linear(p_min,H,z,W_aim,Nx1,Nx2,dx1,dx2,fft2_Kernel,err_tol,it_max,h_ref)
