...
%% Settings
% Algorithm settings:
h_s     = 4e-8;                                                             % [m] seperating distance between upper and lower reference planes
...
[p_con,g,err] = elpl_contact_pressure_akchurin_circular(p_hd,sld.H,p_con_ini,geo.prof,h_s,geo.Nx1,geo.Nx2,fft2_Kernel_circ,err_tol,it_max,h_ref);
clear p_con_ini;
...
function [p_con,g,err] = elpl_contact_pressure_akchurin_circular(p_min,H,p_con_ini,z,h_s,Nx1,Nx2,fft2_Kernel_circ,err_tol,it_max,h_ref)
